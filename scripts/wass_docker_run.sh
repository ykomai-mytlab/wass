...
docker run -p 8080:8080 --net my-network --name wass -e REDISADDR="redis" -e LOCAL_USER_ID=`id -u $USER` -v $DATA_CONF_DIR:/DATA_CONF -v $DATA_IN_DIR:/DATA_IN -v $DATA_OUT_DIR:/DATA_OUT -i -t ykomai/wass:latest
